...
def bp_zap(infile, diff_thresh=0.25, nchan_win=5, 
           edgezap=0.15):
    """
...
def combine_pol_dat(infile1, infile2, diff_thresh=0.25, 
                    nchan_win=5, edgezap=0.15):
    """
    combine pol data
    """
    # Get mask chan and data for pol 1
    mm1, dd1 = bp_zap(infile1, diff_thresh=diff_thresh, 
                      nchan_win=nchan_win, edgezap=edgezap) 
    
    # Get mask chan and data for pol 2
    mm2, dd2 = bp_zap(infile2, diff_thresh=diff_thresh, 
                      nchan_win=nchan_win, edgezap=edgezap) 
...
def combine_pol_fil(args):
    ...
    dd = combine_pol_dat(infile1, infile2, diff_thresh=diff_thresh,
                         nchan_win=nchan_win, edgezap=edgezap)
